...
if (isset($_POST))
{
	...
	$_SESSION["res4"]=$_POST["res3"];	
	/*die($_SESSION["res1"]."-".$_POST["res"]);*/
	echo("<script> window.location.href='" . "pregunta5.php" . "'</script>");
...
<body>
<img src="img/5_pregunta.jpg" width="790px" height="700px" />
<div class="contenedorb">

    <div class="btntigr">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn1">
    <img src="img/opcion4a.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btncevich">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn2">
    <img src="img/opcion4b.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btnlocro">
    <form name="form" action="pregunta4.php" method="post" >
    <input type="hidden" name="res3" id="res3" /> 
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn3">
    <img src="img/opcion4c.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btnfritada">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn4">
    <img src="img/opcion4d.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="respuesta" id="respuesta" style="display:none">
    <img src="img/repuesta4.png" width="406px" height="169px" />
    </div>
