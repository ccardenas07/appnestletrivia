...
if (isset($_POST))
{
	...
	$_SESSION["res2"]=$_POST["res1"];	
	/*die($_SESSION["res1"]."-".$_POST["res"]);*/
	echo("<script> window.location.href='" . "pregunta3.php" . "'</script>");
...
<body>
<img src="img/3_pregunta.jpg" width="790px" height="700px" />
<div class="contenedorb">

    <div class="btntigr">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn1">
    <img src="img/opcion2a.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btncevich">
    <form name="form" id="form" action="pregunta2.php" method="post" >
  <input type="hidden" name="res1" id="res1" /> 
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn2">
    <img src="img/opcion2b.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btnlocro">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn3">
    <img src="img/opcion2c.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btnfritada">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn4">
    <img src="img/opcion2d.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="respuesta" id="respuesta" style="display:none">
    <img src="img/repuesta2.png" width="406px" height="169px" />
    </div>
