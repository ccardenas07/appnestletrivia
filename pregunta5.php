...
<body>
<img src="img/6_pregunta.jpg" width="790px" height="700px" />
<div class="contenedorb">

    <div class="btntigr">
    <form name="form" id="form" action="pregunta5.php" method="post" >
     <input type="hidden" name="res4" id="res4" /> 
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn1">
    <img src="img/opcion5a.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btncevich">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn2">
    <img src="img/opcion5b.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btnlocro">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn3">
    <img src="img/opcion5c.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="btnfritada">
    <a href="#" onclick="ActivarCampoOtroTema()" id="btn4">
    <img src="img/opcion5d.png" width="119px" height="63px" />
    </a>
    </div>
    <div class="respuesta" id="respuesta" style="display:none;">
    <img src="img/repuesta5.png" width="406px" height="169px" />
    </div>
